...
urlpatterns = [
    ...
    path('applications/upload', views.upload_documents, name='upload_documents'),
    path('applications/confirm', views.confirm_job_application, name='confirm_job_application'),
    path('applications/submit', views.submit_job_application, name='submit_job_application'),
