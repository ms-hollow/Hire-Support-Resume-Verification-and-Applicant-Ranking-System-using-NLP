...
from .views import RegisterUserView, LogoutUserView, change_password, user_list, check_email, google_login, auth_email, test_csrf, get_csrf_token, MyTokenObtainPairView, MyTokenRefreshView
...
urlpatterns = [
    ...
    path('token/refresh/', MyTokenRefreshView.as_view(), name='token_refresh'),  # Refresh JWT token
