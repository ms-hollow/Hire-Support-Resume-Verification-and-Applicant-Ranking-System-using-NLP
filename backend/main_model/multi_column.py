...
def column_boxes(page, footer_margin=30, header_margin=30, no_image_text=True, left_margin=5):
    ...
    for b in blocks:
        ...
        # Expand the bbox slightly to the left
        bbox.x0 = max(0, bbox.x0 - left_margin)
