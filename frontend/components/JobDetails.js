    ...
    return (
        <div className="flex flex-col h-full"> 
            ...
            <div className="job-details-box border-b-8 top rounded-t-lg p-4">
                ...
                <p className="font-thin text-fontcolor lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall">{jobDetails.company_name}</p>
                <p className="font-thin text-fontcolor lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall">{jobDetails.job_industry} ({jobDetails.experience_level})</p>
                <div className="flex flex-row mt-2">
                    <div className="flex flex-row">
                        <Image 
                            ...
                            alt="Location Icon" 
                        />
                        <p className="ml-1.5 font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor">{jobDetails.work_location}</p>
                    </div>
                    <div className="flex flex-row mx-4">
                        <Image 
                            ...
                            alt="Work Setup Icon" 
                        />
                        <p className="ml-2 font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor">{jobDetails.work_setup}</p>
                    </div>
                    <div className="flex flex-row">
                        <Image 
                            ...
                            alt="Schedule Icon" 
                        />
                        <p className="ml-2 font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor">{jobDetails.schedule}</p>
                    </div>
                </div>
                <div className="flex flex-row mt-2 px-1">
                    <Image 
                        ...
                        alt="Salary Icon" 
                    />
                    <p className="ml-2 font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall pl-px text-fontcolor">{jobDetails.salary}</p>
                </div>
            ...
            <div className="job-details-box rounded-b-lg overflow-y-auto bg-white p-4">
                ...
                <p id='EmployType' className="font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor pb-3">{jobDetails.employment_type}</p>
                ...
                <p id='JobDescription' className="font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor pb-3">{jobDetails.job_description}</p>
                ...
                <p id='Qualifications' className="font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor pb-3">{jobDetails.qualifications}</p>
                ...
                <p id="Benefits" className="font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor pb-3">
                    {jobDetails.benefits ? (
                        <>
                ...
                <p id='noPosition' className="font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor pb-3">{jobDetails.num_positions}</p>
                ...
                <p id='deadline' className="font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor pb-3">{jobDetails.application_deadline}</p>
                
                {/* Add Notes*/} 
                <p className="font-semibold lg:text-medium mb:text-xsmall sm:text-xsmall xsm:text-xsmall xxsm:text-xsmall text-fontcolor "> Additional Note </p>
                <p id='Notes' className="font-thin lg:text-xsmall mb:text-xsmall sm:text-xxsmall xsm:text-xxsmall xxsm:text-xxsmall text-fontcolor pb-6">{jobDetails.additional_notes}</p>
