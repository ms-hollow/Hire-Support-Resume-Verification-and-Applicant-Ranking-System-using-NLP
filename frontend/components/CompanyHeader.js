        ...
        <header className="fixed top-0 w-full bg-background h-16 lg:px-20 mb:px-20 py-5 flex items-center justify-between sm:px-8 xxsm:px-4 z-50">
            <div className="flex items-center">
                ...
                <ul className="justify-center items-center mt-1 hidden md:flex space-x-10">
                    <li>
                        <Link href="/COMPANY/CompanyHome">Home</Link>
                    </li>
                    <li>
                        <Link href="/COMPANY/CreateJob">Create Job</Link>
                    </li>
                ...
                <button
                    className="text-3xl focus:outline-none text-primary md:hidden ml-4 mt-3"
                    onClick={toggleMenu}
                >
                    ☰
                </button>
                ...
                <div className="relative">
                    ...
                    {isDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-background shadow-md transition-all duration-300">
                            <ul>
                                <li className="px-4 py-3 hover:bg-primary hover:text-background cursor-pointer transition-all duration-300">
                                    <Link
            ...
            {/* Hamburger Menu */}
            <div
                className={`fixed z-50 top-0 left-0 w-52 bg-background h-screen md:hidden shadow-[0px_0px_4px_rgba(0,0,0,0.1)] transition-transform duration-300 ease-in-out ${
            ...
            >
                ...
                <ul className="flex flex-col items-start">
                    <li className="py-2 hover:bg-primary hover:text-background cursor-pointer transition-all duration-300 w-full">
                        <Link
                    ...
                    <li className="py-2 hover:bg-primary hover:text-background cursor-pointer transition-all duration-300 w-full">
                        <Link
                            ...
                            className="block px-4 py-2"
                        >
                            <p className="pl-2">Applicants Summary </p>
                        </Link>
                    </li>
                </ul>
            </div>
