      ...
      <div className="flex items-center gap-5">
        ...
        <div className="relative">
          ...
          {isDropdownOpen && (
           ...
           <ul>
             <li className= "px-4 py-3 hover:bg-primary hover:text-background cursor-pointer transition-all duration-300"><Link href="/COMPANY/CompanyProfile" onClick={toggleDropdown}>Profile</Link></li>
