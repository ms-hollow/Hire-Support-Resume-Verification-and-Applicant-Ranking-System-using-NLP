...
import Image from "next/image";
          ...
          export default function CompanySettings() {
            const [formData, setFormData] = useState({
              ...
              criteria: {
                ...
                skills: { primary: "", secondary: "", additional: "", weight: "" },
                education: { firstChoice: "", secondChoice: "", thirdChoice: "", weight: "" },
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            {[
              ...
              "Good Moral/Behavior Certificate",
            ].map((doc, index) => (
              <label key={index} className="flex items-center space-x-2 mb-2">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.checked) docs.push(doc);
                    else docs.splice(docs.indexOf(doc), 1);
                    setFormData((prev) => ({
                      ...prev,
            ...
            <div className="w-2/3 bg-white shadow-md rounded-lg p-6">
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCriteriaChange("workExperience", "weight", e.target.value)
                      }
                ...
                <div className="mb-4">
                  ...
                  Directly Relevant<span className="font-medium"> (Put roles that are exactly alike or have equal importance for the position)</span>
                  </label>
                  <select
                    value={formData.criteria.workExperience.directlyRelevant || ""}
                    onChange={(e) =>
                      handleCriteriaChange("workExperience", "directlyRelevant", e.target.value)
                    }
                ...
                <div className="mb-4">
                  <label className="block text-sm font-semibold text-fontcolor mb-1">
                    Highly Relevant<span className="font-medium"> (Put roles with significant overlap in core responsibilities)</span>
                  </label>
                  <select
                    value={formData.criteria.workExperience.highlyRelevant || ""}
                    onChange={(e) =>
                      handleCriteriaChange("workExperience", "highlyRelevant", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-black"
                  >
                    <option value="" disabled></option>
                ...
                <div className="mb-4">
                  <label className="block text-sm font-semibold text-fontcolor mb-1">
                    Moderately Relevant<span className="font-medium"> (Put roles in the same domain with some transferable skills)</span>
                  </label>
                  <select
                    value={formData.criteria.workExperience.moderatelyRelevant || ""}
                    onChange={(e) =>
                      handleCriteriaChange("workExperience", "moderatelyRelevant", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-black"
                  >
                    <option value="" disabled></option>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <input
                      ...
                      onChange={(e) => handleCriteriaChange("skills", "weight", e.target.value)}
                      className="w-16 border border-gray-300 rounded-lg px-2 py-1 text-sm text-fontcolor text-center"
                    />
                  </div>
                </div>
                ...
                {[ 
                  ...
                  <div key={index} className="mb-4">
                    <label className="block text-sm font-semibold text-fontcolor mb-1">
                    {skill.label.split('(')[0]}<span className="font-medium">({skill.label.split('(')[1]}</span>
                    </label>
                    <select
                      value={formData.criteria.skills[skill.key] || ""}
                      onChange={(e) => handleCriteriaChange("skills", skill.key, e.target.value)}
                      className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-black"
                    >
                      <option value="" disabled></option>
                    </select>
              ...
              <input
                ...
                onChange={(e) => handleCriteriaChange("education", "weight", e.target.value)}
              ...
              {[{
                ...
                <div key={index} className="mb-4">
                  <label className="block text-sm font-semibold text-fontcolor mb-1">
                    {edu.label.split('(')[0]}<span className="font-medium">({edu.label.split('(')[1]}</span>
                  </label>
                  <select
                    value={formData.criteria.education[edu.key] || ""}
                    onChange={(e) => handleCriteriaChange("education", edu.key, e.target.value)}
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-black"
                  >
                  </select>
                </div>
              ...
              <div className="flex items-center mb-4">
                ...
                />
                <label className="text-sm text-fontcolor font-semibold">School Preference <span className="font-medium"> (Put any preferred institutions, if applicable)</span>
                  </label> 
              </div>
              <select
                value={formData.criteria.education.schoolPreference || ""}
                onChange={(e) => handleCriteriaChange("education", "schoolPreference", e.target.value)}
                className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-black mb-4"
              >
              </select>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    onChange={(e) => handleCriteriaChange("certificates", "weight", e.target.value)}
                    className="w-16 border border-gray-300 rounded-lg px-2 py-1 text-sm text-black text-center"
                  />
                </div>
              </div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-semibold text-fontcolor mb-1">
                  Institution Preference Bonus{" "}
                  <span className="font-medium">
                    (Put any preferred certification provider, if applicable)
                  </span>
                </label>
                <select
                  value={formData.criteria.certificates.preferred || ""}
                  onChange={(e) => handleCriteriaChange("certificates", "preferred", e.target.value)}
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm text-black"
                >
                  <option value="" disabled></option>
                </select>
            ...
            <div className="mb-6">
              ...
              <select
                ...
                className="w- border border-gray-300 rounded-lg px-4 py-2 text-sm text-fontcolor"
                value={formData.criteria.verification || ""}
                onChange={(e) => handleCriteriaChange("criteria", "verification", e.target.value)}
              >
                <option value="" disabled></option>
              </select>
            </div>
