    ...
    const fetchData = async () => {
      try {
        ...
        const jobDetailsResponse = await fetch(
          "/placeHolder/dummy_JobDetails.json"
        );
          ...
          <form onSubmit={handleSettingsSubmit} className="flex gap-6">
            ...
            <div className="w-1/3 flex flex-col gap-6 sticky top-20 h-max">
              <div className="bg-white shadow-md rounded-lg p-6">
                ...
                <p className="text-sm text-fontcolor mt-1 mb-4">
                  Please make sure to upload all the required documents before
                  the deadline.
                </p>
                {[
                  "Resume",
              ...
              <div className="bg-white shadow-md rounded-lg p-6">
                ...
                <p className="text-sm text-fontcolor mt-1 mb-4">
                  Select the deadline date for submitting the required
                  documents.
                </p>
                <input
                  type="date"
            ...
            <div className="w-2/3 bg-white shadow-md rounded-lg p-6">
              ...
              <div className="mb-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-fontcolor mb-1">
                      ...
                      <span className="font-medium text-xsmall">
                        {" "}
                        (Put roles that are exactly alike or have equal
                    ...
                    <div
                      ...
                      onClick={() =>
                        setDropdownOpen({
                          ...dropdownOpen,
                          directly: !dropdownOpen.directly,
                        })
                      }
                    >
                      {formData.criteria.workExperience.directlyRelevant
                      ...
                      <FaChevronDown
                        className={`ml-auto transform ${
                          dropdownOpen.directly ? "rotate-180" : "rotate-0"
                ...
                <div className="mb-4">
                  <div>
                    <label className="block text-sm font-semibold text-fontcolor mb-1">
                      ...
                      <span className="font-medium text-xsmall">
                        {" "}
                        (Put roles with significant overlap in core
                        responsibilities)
                      </span>
                    </label>
                    ...
                    >
                      ...
                      {formData.criteria.workExperience.highlyRelevant?.length >
                      0 ? (
                      ...
                      <FaChevronDown
                        className={`ml-auto transform ${
                          dropdownOpen.highly ? "rotate-180" : "rotate-0"
                        } transition-transform`}
                      />
                    </div>
                ...
                <div className="mb-4">
                  <div>
                    <label className="block text-sm font-semibold text-fontcolor mb-1">
                      ...
                      <span className="font-medium text-xsmall">
                        {" "}
                        (Put roles in the same domain with some transferable
                        skills)
                      </span>
                    </label>
                    ...
                    <div
                      ...
                      onClick={() =>
                        setDropdownOpen({
                          ...dropdownOpen,
                          moderately: !dropdownOpen.moderately,
                        })
                      }
                    >
                      {/* Show selected options inside the input */}
                      ...
                      <FaChevronDown
                        className={`ml-auto transform ${
                          dropdownOpen.moderately ? "rotate-180" : "rotate-0"
                        } transition-transform`}
                      />
                    </div>
                      ...
                      <input
                        ...
                        onChange={() =>
                          handleCriteriaChange(
                            "skills",
                            "enabled",
                            !formData.criteria.skills.enabled
                          )
                  ...
                  <div className="mb-4">
                    <div>
                      <label className="block text-sm font-semibold text-fontcolor mb-1">
                        Primary Skills{" "}
                        <span className="font-medium text-xsmall">
                          (Put roles with the most relevant skills and
                          experience){" "}
                        </span>
                      </label>
                      ...
                      >
                        ...
                        <FaChevronDown
                          className={`ml-auto transform ${
                            dropdownOpen.primary ? "rotate-180" : "rotate-0"
                          } transition-transform`}
                        />
                      </div>
                      ...
                      {dropdownOpen.primary && (
                        <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                          ...
                          <div className="sticky top-0 bg-white z-10 p-2 border-b border-gray-200">
                            ...
                            />
                            {searchTerm.primary &&
                              !options.skills.includes(searchTerm.primary) && (
                                <button
                                  className="mt-2 w-full text-sm text-white bg-blue-500 hover:bg-blue-600 py-1 px-2 rounded-md"
                                  onClick={() =>
                                    handleAddCustomOption(
                          ...
                          {/* Available Options List */}
                          {getFilteredOptions("skills", "primarySkills").map(
                            (option, index) => (
                              <label
                                key={index}
                                className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer"
                  ...
                  <div className="mb-4">
                    <div>
                      <label className="block text-sm font-semibold text-fontcolor mb-1">
                        ...
                        <span className="font-medium text-xsmall">
                          {" "}
                          (Put important skills that are frequently used but not
                      ...
                      <div
                        ...
                        onClick={() =>
                          setDropdownOpen({
                            ...dropdownOpen,
                            secondary: !dropdownOpen.secondary,
                          })
                        }
                      >
                        {/* Show selected options inside the input */}
                        {formData.criteria.skills.secondarySkills?.length >
                        0 ? (
                        ...
                        <FaChevronDown
                          className={`ml-auto transform ${
                            dropdownOpen.secondary ? "rotate-180" : "rotate-0"
                          } transition-transform`}
                        />
                      </div>
                      ...
                      {dropdownOpen.secondary && (
                        <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                          ...
                          {/* Available Options List */}
                          {getFilteredOptions("skills", "secondarySkills").map(
                            (option, index) => (
                              <label
                                key={index}
                                className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer"
                  ...
                  <div className="mb-4">
                    <div>
                      <label className="block text-sm font-semibold text-fontcolor mb-1">
                        ...
                        <span className="font-medium text-xsmall">
                          {" "}
                          (nice-to-have skills that would give a candidate an
                          edge but aren't necessary for the core job functions)
                        </span>
                      </label>
                      ...
                      <div
                        ...
                        onClick={() =>
                          setDropdownOpen({
                            ...dropdownOpen,
                            additional: !dropdownOpen.additional,
                          })
                        }
                      >
                        {/* Show selected options inside the input */}
                        {formData.criteria.skills.additionalSkills?.length >
                        0 ? (
                        ...
                        <FaChevronDown
                          className={`ml-auto transform ${
                            dropdownOpen.additional ? "rotate-180" : "rotate-0"
                          } transition-transform`}
                        />
                      </div>
                      ...
                      {dropdownOpen.additional && (
                        <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                          ...
                          {/* Available Options List */}
                          {getFilteredOptions("skills", "additionalSkills").map(
                            (option, index) => (
                              <label
                                key={index}
                                className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer"
                  ...
                  <div className="mb-6">
                    ...
                    <div className="mb-4">
                      <label className="block text-sm font-semibold text-fontcolor mb-1">
                        1st Choice Field of Study{" "}
                        <span className="font-medium text-xsmall">
                          (Put the most directly relevant fields of study for
                          the position)
                        </span>
                      </label>
                      ...
                      <div
                        ...
                        onClick={() =>
                          setDropdownOpen({
                            ...dropdownOpen,
                            firstChoice: !dropdownOpen.firstChoice,
                          })
                        }
                      >
                        <span>
                        ...
                        <FaChevronDown
                          className={`ml-2 transform ${
                            dropdownOpen.firstChoice ? "rotate-180" : "rotate-0"
                          } transition-transform`}
                        />
                      </div>
                      ...
                      {dropdownOpen.firstChoice && (
                        <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                          ...
                          {getFilteredOptions("education", "firstChoice").map(
                            (option, index) => (
                              <label
                                key={index}
                                className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer"
                    ...
                    <div className="mb-4">
                      <label className="block text-sm font-semibold text-fontcolor mb-1">
                        2nd Choice Field of Study
                        <span className="font-medium text-xsmall">
                          (Put closely related fields that have significant
                      ...
                      <div
                        ...
                        onClick={() =>
                          setDropdownOpen({
                            ...dropdownOpen,
                            secondChoice: !dropdownOpen.secondChoice,
                          })
                        }
                      >
                        <span>
                      ...
                      {dropdownOpen.secondChoice && (
                        <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                          ...
                          {getFilteredOptions("education", "secondChoice").map(
                            (option, index) => (
                              <label
                                key={index}
                                className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer"
                    ...
                    <div className="mb-4">
                      <label className="block text-sm font-semibold text-fontcolor mb-1">
                        3rd Choice Field of Study
                        <span className="font-medium text-xsmall">
                          (Put fields that have some relevance or provide useful
                      ...
                      <div
                        ...
                        onClick={() =>
                          setDropdownOpen({
                            ...dropdownOpen,
                            thirdChoice: !dropdownOpen.thirdChoice,
                          })
                        }
                      >
                        <span>
                        ...
                        <FaChevronDown
                          className={`ml-2 transform ${
                            dropdownOpen.thirdChoice ? "rotate-180" : "rotate-0"
                          } transition-transform`}
                        />
                      </div>
                ...
                <div className="mb-4">
                  <div>
                    ...
                    >
                      {/* Show selected options inside the input */}
                      {formData.criteria.schools.schoolPreference?.length >
                      0 ? (
                      ...
                      <FaChevronDown
                        className={`ml-auto transform ${
                          dropdownOpen.school ? "rotate-180" : "rotate-0"
                        } transition-transform`}
                      />
                    </div>
                    ...
                    {dropdownOpen.school && (
                      <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                        ...
                        <div className="sticky top-0 bg-white z-10 p-2 border-b border-gray-200">
                          ...
                          />
                          {searchTerm.school &&
                            !options.schools.includes(searchTerm.school) && (
                              <button
                                className="mt-2 w-full text-sm text-white bg-blue-500 hover:bg-blue-600 py-1 px-2 rounded-md"
                                onClick={() =>
                                  handleAddCustomOption(
                        ...
                        {/* Available Options List */}
                        {getFilteredOptions("schools", "schoolPreference").map(
                          (option, index) => (
                            <label
                              key={index}
                              className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer"
                ...
                <div className="mb-4">
                  <div>
                    <label className="block text-sm font-semibold text-fontcolor mb-1">
                      ...
                      <span className="font-medium text-xsmall">
                        (Select any preferred certificates, if applicable)
                      </span>
                    </label>
                    ...
                    <div
                      ...
                      onClick={() =>
                        setDropdownOpen({
                          ...dropdownOpen,
                          certicatePrefered: !dropdownOpen.certicatePrefered,
                        })
                      }
                    >
                      {/* Show selected options inside the input */}
                    ...
                    {dropdownOpen.certicatePrefered && (
                      <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                        ...
                        <div className="sticky top-0 bg-white z-10 p-2 border-b border-gray-200">
                          <input
                            ...
                            onChange={(e) =>
                              setSearchTerm({
                                ...searchTerm,
                                certicatePrefered: e.target.value,
                              })
                            }
                            className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
                            onKeyDown={(e) => {
                        ...
                        {/* Available Options List */}
                        {getFilteredOptions("certificates", "preferred").map(
                          (option, index) => (
                            <label
                              key={index}
                              className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer"
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="flex items-center space-x-3">
                      <input
                        type="radio"
                        name="weightOfCriteria"
                        value={item}
                        checked={formData.weightOfCriteria === item}
                        onChange={handleInputChange}
                        className="h-4 w-4 text-black focus:ring focus:ring-primary rounded-full"
                      />
                      <label
                        htmlFor={`criteria-${index}`}
                        className="text-sm text-fontcolor font-medium"
                      >
                        {item}
                      </label>
                    </div>
              ...
              <div className="flex justify-between mt-8">
                ...
                <button
                  type="button"
                  onClick={(e) => handleSettingsSubmit(e, "draft")}
