              ...
              <div className="bg-white shadow-md rounded-lg p-6">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (/^\d*$/.test(value) && Number(value) <= 100) {
                              handleCriteriaChange("workExperience", "weight", value);
                            }
                          }}
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-fontcolor mb-1">
                      ...
                      <span className="font-medium text-xsmall">
                        (Put roles that are exactly alike or have equal importance for the position)
                      </span>
                    </label>
                    <div 
                ...
                <div className="mb-4">
                  <label className="block text-sm font-semibold text-fontcolor mb-1">
                    Highly Relevant
                    <span className="font-medium text-xsmall">
                       (Put roles with significant overlap in core responsibilities)
                    </span>
                  </label>
                  <div 
                    className="w-full border border-gray-300 rounded-lg px-4 py-2 text-medium text-fontcolor cursor-pointer flex items-center justify-between" 
                ...
                <div className="mb-4">
                  ...
                  {dropdownOpen.moderately && (
                    ...
                    <div className="mb-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const value = e.target.value;
                            // Allow only numbers and check the range
                            if (/^\d*$/.test(value) && Number(value) <= 100) {
                    ...
                    <div className="mb-4">
                      ...
                      >
                        <span>
                          {formData.criteria.workExperience.primarySkills?.length > 0
                            ? formData.criteria.workExperience.primarySkills.join(", ")
                            ...
                            .map((option, index) => (
                              <label key={index} className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer">
                                <input
                                  type="checkbox"
                                  value={option}
                                  checked={formData.criteria.workExperience.primarySkills?.includes(option)}
                                  onChange={() => handleMultiSelectChange("workExperience", "primarySkills", option)}
                                  className="ml-5 w-5 h-5"
                                />
                                <span className="text-medium ml-5">{option}</span>
                              </label>
                    ...
                    <div className="mb-4">
                      ...
                      >
                        <span>
                          {formData.criteria.workExperience.secondarySkills?.length > 0
                            ? formData.criteria.workExperience.secondarySkills.join(", ")
                            ...
                            .map((option, index) => (
                              <label key={index} className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer">
                                <input
                                  type="checkbox"
                                  value={option}
                                  checked={formData.criteria.workExperience.secondarySkills?.includes(option)}
                                  onChange={() => handleMultiSelectChange("workExperience", "secondarySkills", option)}
                                  className="ml-5 w-5 h-5"
                                />
                                <span className="text-medium ml-5">{option}</span>
                              </label>
                    ...
                    <div className="mb-4">
                      ...
                      >
                        <span>
                          {formData.criteria.workExperience.additionalSkills?.length > 0
                            ? formData.criteria.workExperience.additionalSkills.join(", ")
                            ...
                            .map((option, index) => (
                              <label key={index} className="flex items-center gap-1 py-2 hover:bg-gray-100 cursor-pointer">
                                <input
                                  type="checkbox"
                                  value={option}
                                  checked={formData.criteria.workExperience.additionalSkills?.includes(option)}
                                  onChange={() => handleMultiSelectChange("workExperience", "additionalSkills", option)}
                                  className="ml-5 w-5 h-5"
                                />
                                <span className="text-medium ml-5">{option}</span>
                              </label>
                    ...
                    {dropdownOpen.schoolPreference && (
                      <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                        ...
                        {options?.education?.schools?.length > 0 && (
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const updatedSchools = e.target.checked
                                      ...
                                      : formData.criteria.schools.selectedOptions.filter(
                                          (s) => s !== school
                                        );
                                    setFormData((prev) => ({
                                      ...prev,
                  ...
                  <div
                    ...
                    onClick={() =>
                      setDropdownOpen({
                        ...dropdownOpen,
                        certificatePreference: !dropdownOpen.certificatePreference,
                      })
                    }
                  >
                    <span>
                      {formData.criteria.certificates.preferred || "Select Certificate Preference"}
                    </span>
                    <FaChevronDown
                      className={`ml-2 transform ${
                        dropdownOpen.certificatePreference ? "rotate-180" : "rotate-0"
                      } transition-transform`}
                    />
                  </div>
                  {dropdownOpen.certificatePreference && (
                    <div className="top-full mt-1 w-full border border-gray-300 rounded-lg bg-white shadow-lg text-fontcolor z-10 max-h-60 overflow-y-auto">
                      ...
                      <div>
                        {options?.education?.certificates?.length > 0 && (
                          options.education.certificates
                            .filter((certificate) =>
                              certificate.toLowerCase().includes(searchTerm.toLowerCase())
                            )
                            .map((certificate, index) => (
                              ...
                              >
                                <input
                                  type="checkbox"
                                  value={certificate}
                                  checked={formData.criteria.certificates.preferred === certificate}
                                  onChange={(e) => {
                                    setFormData((prev) => ({
                                      ...prev,
                                      criteria: {
                                        ...prev.criteria,
                                        certificates: {
                                          ...prev.criteria.certificates,
                                          preferred: e.target.checked ? certificate : "",
                                        },
                                      },
                                    }));
                                  }}
                                  className="ml-5 w-5 h-5"
                                />
                                <span className="text-medium ml-5">{certificate}</span>
                              </label>
                            ))
                        )}
                      </div>
