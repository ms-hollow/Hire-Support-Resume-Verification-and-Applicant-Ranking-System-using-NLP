                    ...
                    {step === 1 && (
                        ...
                        <form>
                            ...
                            <div className="flex justify-end">
                                <button className="button1 mt-12 flex items-center justify-center" onClick={handleNextStep}> 
                                    <div className="flex items-center space-x-2">
                                        <p className="lg:text-medium mb:text-medium sm:text-xxsmal xsm:text-xxsmal font-medium text-center">Continue</p>
                                        <Image 
                                            src="/Arrow Right.svg" 
                                            width={23} 
                                            height={10} 
                            ...
                            <p className="text-xsmall text-fontcolor pb-1 font-medium">
                                Don’t have an account? <span className="font-semibold"><Link href="/GENERAL/Login" className='underline'>Sign in</Link></span>
                            </p>
                        </form>
                    )}
