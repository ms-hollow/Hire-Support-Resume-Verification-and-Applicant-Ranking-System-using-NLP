                        ...
                        <div className="pt-8 pb-8">
                            <div className="w-full overflow-hidden rounded-t-lg rounded-b-lg border border-[#F5F5F5]">
                                ...
                                <tbody>
                                    ...
                                    <td className="p-2 ">
                                        <p className="pl-2 font-thin text-medium text-fontcolor">Application Date</p>
                                        <p id="appDate" className=" pl-2 font-semibold text-medium text-fontcolor">09-28-2024</p>
                                    </td>
                                    </tr>
                                    <tr className="px-2 border-b border-[#F5F5F5]">
                                    <td className="p-2 ">
                                        <p className="pl-2 font-thin text-medium text-fontcolor">Application ID</p>
                                        <p id="appID" className="pl-2 font-semibold text-medium text-fontcolor">00-0000</p>
                                    </td>
                                    </tr>
                                    <tr className="px-2 border-b border-[#F5F5F5]">
                                    <td className="p-2">
                                        <p className="pl-2 font-thin text-medium text-fontcolor">Application Status</p>
                                        <p id="status" className="pl-2 font-semibold text-medium text-primary">Pending</p>
                                    </td>
                                    </tr>
                                    <tr className="px-2">
                                    <td className="p-2">
                                        <p className="pl-2 font-thin text-medium text-fontcolor">HR Note</p>
                                        <p id="note" className="pl-2 font-semibold text-medium text-fontcolor">Lorem ipsum dolor sit amet</p>
                                    </td>
                                    </tr>
                                </tbody>
                                </table>
