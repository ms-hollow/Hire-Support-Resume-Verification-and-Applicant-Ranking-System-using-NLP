...
import { getSpecificJobApplication } from "@/pages/api/applicantJobApi";
    ...
    return (
        <div>
            ...
            <div className="lg:pt-28 mb:pt-24 xsm:pt-24 sm:pt-24 xxsm:pt-24 lg:px-20 mb:px-20 sm:px-8 xsm:px-4 xxsm:px-4 mx-auto">
                <h1 className="lg:text-xl mb:text-xl sm:text-large text-primary mb-2">
                    Application Submitted
                </h1>
                <p
                    id="full-name"
                    className="font-thin lg:text-medium mb:text-meduim sm:text-xsmall xsm:text-xsmall text-fontcolor mb-8"
                >
                    Hi, {applicationDetails?.applicant?.first_name}{" "}
                    {applicationDetails?.applicant?.middle_name}{" "}
                    {applicationDetails?.applicant?.last_name}{" "}
                </p>

                <div className="flex items-center justify-center pb-8">
                    <div className="job-application-box rounded-xs px-8 py-5 mx-auto">
                        <p className="font-semibold lg:text-large mb:text-large sm:text-xsmall xsm:text-xsmall xxsm:text-xsmall text-primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr className="px-2 border-b border-[#F5F5F5]">
                                            <td className="p-2 ">
                                                ...
                                                >
                                                    {
                                                        applicationDetails?.job_application_id
                                                    }
                                                </p>
                                            </td>
                                        </tr>
                                        <tr className="px-2 border-b border-[#F5F5F5]">
                                            <td className="p-2">
                                                ...
                                                <p
                                                    id="status"
                                                    className="pl-2 font-semibold lg:text-medium mb:text-medium sm:text-xsmall xsm:text-xsmall xxsm:text-xsmall text-primary"
                                                >
                                                    {toTitleCase(
