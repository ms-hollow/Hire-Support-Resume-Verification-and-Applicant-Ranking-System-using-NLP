            ...
            <div className="lg:pt-28 mb:pt-24 xsm:pt-24 sm:pt-24 mb:px-20 sm:px-20 xsm:px-20 lg:px-20 mx-auto">
                ...
                <div className="box-container p-8 bg-white rounded-lg shadow-md border border-gray-200 max-w-3xl mx-auto mt-6">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* Progress Bar */}
                        <div className="w-full bg-gray-200 rounded-full overflow-hidden mt-4 mb-6">
                            <div
                                className={`h-2 rounded-full transition-all duration-300 bg-primary ${step === 1 ? "w-1/3" : step === 2 ? "w-2/3" : step === 8 ? "w-full" : `${(step / 8) * 100}%`}`}
                            ></div>
                        </div>
                        ...
                        {/* Contact Number */}
                        <div>
                            <label className="block text-gray-700 font-medium mt-2">Contact Number</label>
                            <input
                                type="tel"
                                name="contactNumber"
                        ...
                        {/* Sex */}
                        <div>
                            <label className="block text-gray-700 font-medium mt-2">Sex</label>
                            <select
                                name="sex"
                                value={formData.sex}
                                onChange={handleChange}
                        ...
                        {/* Address */}
                        <div>
                            <label className="block text-gray-700 font-medium mt-2">Complete Address</label>
                            <input
                                type="text"
                                name="address"
                        ...
                        {/* LinkedIn Profile */}
                        <div>
                            <label className="block text-gray-700 font-medium mt-2">LinkedIn Profile</label>
                            <input
                                type="url"
                                name="linkedIn"
                        ...
                        <div className="mt-4 flex justify-between">
                            <button
                                type="button"
                                onClick={handleEdit}
                                className="rounded-lg py-2 px-6 bg-[var(--secondary)] text-[var(--fontcolor)]"
                            >
                                Edit
                            </button>
                            <button
                                type="submit"
                                className="rounded-lg py-2 px-6 bg-[var(--primary)] text-[var(--foreground)]"
                            >
                                Continue
                            </button>
                        </div>
